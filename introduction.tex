...
\todo[inline,color=red!80!green!25]{Remove Authors}
\todo[inline,color=red!80!green!25]{SW result in new model?}
...
\todo[inline,color=red!80!green!25]{Catalan?}

In the context of random colorings of an input graph $G$,
...
but can still answer relevant queries to a valid sampled object, using a sub-linear number of local probes to the input graph $G$.
...
\todo[inline,color=red!80!green!25]{Separate thms or bullets for ER and SBM?}
