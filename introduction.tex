...
Next, we show that these assumptions can be realized in Erd\"os-R\'enyi random graphs, and the Stochastic Block Model.
SBM presents additional challenges for assigning community labels to vertices.
...
\todo[inline,color=red!80!green!25]{Why is Kleinberg important?}
