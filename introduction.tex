...
We implement \func{All-Neighbors} queries for the Small World model,
...
\todo{Add reference for interval-summable paper "An approximate L1-difference algorithm for massive data streams"}
...
for example, \func{First-Return} queries correspond to $\func{Next-Child}$ queries on trees,
...
\todo{First talk about independent copies}
