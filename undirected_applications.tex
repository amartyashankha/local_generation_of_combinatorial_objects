...
\begin{restatable}{corollary}{res:oblivious:corol} \todo{Change to thm?}
...
\label{thm:er-optimal} \todo{Is this needed?}
...
\end{restatable}
\begin{restatable}{corollary}{res:sbm-construct}\label{cor:sbm-construct} \todo{Change this to thm?}
