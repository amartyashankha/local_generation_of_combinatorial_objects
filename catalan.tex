...
This can be done by invoking $\func{Height}(x_i+1)$, if it has not been determined already.
...
We sample a point in the middle\todo{middle?} of this interval and fix the boundary invariant by sampling another point,
