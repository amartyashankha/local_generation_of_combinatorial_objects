...
Using the technique of path-coupling, Vigoda \cite{glauber_survey} showed that for $q > 2\Delta$,
...
Since $t \le 6\ln n$, the overall runtime is $\mathcal O(n^{6.12/\alpha}\Delta\log n)$.
\end{proof}
