...
(given that we do not to support \func{Random-Neighbor} queries),
...
\todo[inline,color=red!80!green!25]{Low degree: Next Neighbor => Random Neighbor}
...
\todo[inline,color=red!80!green!25]{More on importance. Better description.}
