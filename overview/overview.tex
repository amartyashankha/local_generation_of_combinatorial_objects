...
which differ based on what type of access to $\{p_d\}$ is provided to the algorithm.
If the algorithm is provided cumulative distribution function (CDF) queries to $\{p_d\}$,
